...
export default function ForecastOtherScreen({ navigation }) {
    var costDict = calcostDict();
    var total = calForecastData();
    var prob = ((costDict["Other"]/(total))*100).toFixed(2);
        ...
        <View style={styles.container}>
            ...
            <Text
                style={styles.paragraph2}>
                    📊  {prob}% of your total spending will be on Other next month.
                </Text>
        </View>
    );
};
